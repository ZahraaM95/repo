...
import 'package:flutter_application_8/core/error/filuer.dart';
import 'package:flutter_application_8/featuers/Home/view/choese_lesson.dart';
import 'package:flutter_application_8/featuers/quiz/quiz.dart';
          ...
          child: Obx(() {
            if (controller.isLoading.value) {
              ...
              return Column(
                ...
                children: [
              Text('${controller.lessons.length}/ ${controller.lessons.length} ' ,
    ...
    return Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
               ...
               color: AppColor.primaryColor , // يمكنك استخدام AppColor.primaryColor هنا إذا كنت قد عرفت اللون في مكان آخر
            ...
            children: [
              ...
              IconButton(
                ...
                icon: SvgPicture.asset(
                  lessonCompleted && lessonTaken ? 'assets/svg/noun-done-2905124 2.svg' 
                  : lessonTaken ? 'assets/svg/Group.svg' : 'assets/svg/lock2.svg',
                ),
              ),
            ],
          ),
